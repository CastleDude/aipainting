...
export const PRESETS: Preset[] = [
  ...
  // ── 4. Product Ad ──
  {
    ...
    hasRefImage: true,
    promptTemplate:
      "Create a professional product advertisement poster. Product: {title}. {ref_style} Ad copy: \"{copy}\". Key selling points: {points}. {details} {size_desc}. Clean, commercial-grade product photography style, professional lighting, eye-catching composition. {custom} High quality marketing poster.",
    defaultModel: "schnell",
    defaultAspectRatio: "3:4",
    defaultNumImages: 1,
    baseCost: 2,
