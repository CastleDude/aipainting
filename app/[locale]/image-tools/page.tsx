...
export default async function ImageToolsPage() {
  ...
  const toolMessages = {
    ...
    format: t("image_tools.tabs.format"),
    ...
    desc_format: t("image_tools.descriptions.format"),
    ...
    compress_reset: t("image_tools.compress.reset_results"),
    compress_auto: t("image_tools.compress.auto"),
    compress_quality_mode: t("image_tools.compress.quality_mode"),
    compress_size_mode: t("image_tools.compress.size_mode"),
    format_target: t("image_tools.format.target"),
    format_convert: t("image_tools.format.convert"),
    format_download_all: t("image_tools.format.download_all"),
    format_reset: t("image_tools.format.reset"),
    format_delete_all: t("image_tools.format.delete_all"),
    format_hint: t("image_tools.format.hint"),
    format_max_hint: t("image_tools.format.max_hint"),
    format_too_many: t("image_tools.format.too_many"),
    format_jpeg: t("image_tools.format.jpeg"),
    format_png: t("image_tools.format.png"),
    format_webp: t("image_tools.format.webp"),
    format_avif: t("image_tools.format.avif"),
    format_ico: t("image_tools.format.ico"),
