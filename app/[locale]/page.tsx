            ...
            presets: {
              ...
              age_journey: {
                ...
                params: {
                  ...
                  age_30s: t("presets.age_journey.params.age_30s"),
                  age_40s: t("presets.age_journey.params.age_40s"),
                  age_50s: t("presets.age_journey.params.age_50s"),
                  age_60s: t("presets.age_journey.params.age_60s"),
                  age_70s: t("presets.age_journey.params.age_70s"),
                  age_80s: t("presets.age_journey.params.age_80s"),
                  age_90s: t("presets.age_journey.params.age_90s"),
                  age_100: t("presets.age_journey.params.age_100"),
                  age_200: t("presets.age_journey.params.age_200"),
                  age_500: t("presets.age_journey.params.age_500"),
                  age_1000: t("presets.age_journey.params.age_1000"),
