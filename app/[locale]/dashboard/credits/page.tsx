    ...
    <div className="rounded-xl border border-border/50 bg-bg-card p-4 lg:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4 text-xs text-text-muted">
          <span>当前套餐：<span className="text-text-primary font-medium">{tierConfig.name}</span></span>
          <span>积分数：<span className="text-accent font-semibold text-sm">{credits}</span></span>
        </div>
      </div>
