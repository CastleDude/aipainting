...
export default async function DashboardPage({
  ...
  const dashboardMessages = {
    ...
    credits_title: messages.dashboard?.credits_title || "积分明细",
    credit_count: messages.dashboard?.credit_count || "积分数",
    type_label: messages.dashboard?.type_label || "类型",
    time_label: messages.dashboard?.time_label || "日期时间",
    purpose_label: messages.dashboard?.purpose_label || "用途",
    change_label: messages.dashboard?.change_label || "变动",
    balance_label: messages.dashboard?.balance_label || "余额",
    no_credit_records: messages.dashboard?.no_credit_records || "暂无积分记录",
    credit_recharge: messages.dashboard?.credit_recharge || "充值",
    credit_bonus: messages.dashboard?.credit_bonus || "赠送",
    credit_daily: messages.dashboard?.credit_daily || "发放",
    credit_consume: messages.dashboard?.credit_consume || "消耗",
    credit_expire: messages.dashboard?.credit_expire || "过期",
    credit_adjust: messages.dashboard?.credit_adjust || "调整",
