          ...
          <div className="space-y-6 lg:order-1">
            ...
            <div className="rounded-xl border border-border/50 bg-bg-card p-4">
              ...
              <button
                ...
                className="mt-4 w-full flex items-center gap-2 rounded-lg border border-border/50 p-3 text-sm text-text-secondary hover:border-accent/30 hover:text-text-primary transition-colors"
              >
