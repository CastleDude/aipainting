          ...
          <div className="space-y-6 lg:order-2">
            ...
            {showCredits ? (
              <CreditLog onBack={() => setShowCredits(false)} messages={{
                title: messages.credits_title || "Credit History",
                current_plan: messages.current_plan || "Current Plan",
                credit_count: messages.credit_count || "Credits",
                type: messages.type_label || "Type",
                time: messages.time_label || "Date/Time",
                purpose: messages.purpose_label || "Purpose",
                change: messages.change_label || "Change",
                balance: messages.balance_label || "Balance",
                loading: messages.loading || "Loading...",
                no_records: messages.no_credit_records || "No credit records",
                back: messages.back_to_history || "Back to History",
                recharge: messages.credit_recharge || "Recharge",
                bonus: messages.credit_bonus || "Bonus",
                daily: messages.credit_daily || "Daily",
                consume: messages.credit_consume || "Consume",
                expire: messages.credit_expire || "Expired",
                adjust: messages.credit_adjust || "Adjust",
              }} />
            ) : showOrders ? (
              <OrderHistory
            ...
            <div className="rounded-xl border border-border/50 bg-bg-card p-4">
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {messages.credits_log_label || "Credit Log"}
                </span>
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  {messages.order_history || "Order History"}
                </span>
                <svg className="h-4 w-4 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                </svg>
